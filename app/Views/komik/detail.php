                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <p class="card-text text-muted"><small class="text-body-secondary"><b>Penerbit: </b><?= $komik['penerbit']; ?></small></p>
                            <a href="<?= base_url('/komik/kemaskini/') . $komik['slug']; ?>" class="btn btn-warning">Edit</a>
                            ...
                            <br><br>
                            <a href="<?= base_url('/komik'); ?>">Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
